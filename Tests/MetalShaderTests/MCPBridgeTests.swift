...
// MARK: - Note on Edge Case Testing
// Edge case tests for the MCP client (timeouts, crashes, malformed JSON, etc.)
// are now covered comprehensively in Tests/Integration/MCPClientIntegrationTests.swift
// using the new MCPClient architecture with dependency injection.
